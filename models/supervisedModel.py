...
class SupervisedModel:
    def __init__(self, args, num_classes, ema_m, T, p_cutoff, lambda_u, \
        ...
        self.train_model = choose_network(args,args.net_from_name, args.net, args.pretrained_from, args.pretrained_model_dir)
        self.eval_model = choose_network(args,args.net_from_name, args.net, args.pretrained_from, args.pretrained_model_dir)
