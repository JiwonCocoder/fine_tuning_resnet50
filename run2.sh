...
python train.py --epoch 200 --batch_size 64 --eval_batch_size 10 --num_eval_iter 100\
                --scheduler_type step --lr 0.002 \
                --learning_type sup --baseline supervised --net resnet50 --net_from_name True \
                --pretrained_from ImageNet_supervised --mixup 0 \
                --data_dir /data/samsung/labeled --dataset MLCC --num_classes 10 \
